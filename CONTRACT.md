...
`cail-sandbox-service` owns the OpenAPI definition. This package owns the
...
persistence, or background process controls.
...
The client and service are exercised together by the local end-to-end workflow
in `kale-integration`.
