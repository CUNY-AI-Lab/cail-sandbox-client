...
- Do not add Cloudflare Computer SDK/runtime behavior, browser-facing credential handling, identity or lease authority, quota authority, or service business logic.
